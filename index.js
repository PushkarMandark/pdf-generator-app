...
const generatePdf = async (htmlContent) => {
    ...
    const pdfBuffer = await page.pdf({
        ...
        footerTemplate: '<div style="font-size:10px; padding: 0 0.5in 0 0.5in; width:100%; display: flex; justify-content: space-between;"><div>Page <span class="pageNumber"></span> of <span class="totalPages"></span></div><div><span class="title"></span></div></div></div>',
    });
    await browser.close();
    return pdfBuffer;
};
